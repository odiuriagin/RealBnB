...
user2.photo.attach(io: user2_avatar, filename: '2.png')
user3.photo.attach(io: user3_avatar, filename: '3.png')
user4.photo.attach(io: user4_avatar, filename: '4.png')
user5.photo.attach(io: user5_avatar, filename: '5.png')
user6.photo.attach(io: user6_avatar, filename: '6.png')
user7.photo.attach(io: user7_avatar, filename: '7.png')
user8.photo.attach(io: user8_avatar, filename: '8.png')
user9.photo.attach(io: user9_avatar, filename: '9.png')
user10.photo.attach(io: user10_avatar, filename: '10.png')
user11.photo.attach(io: user11_avatar, filename: '11.png')
user12.photo.attach(io: user12_avatar, filename: '12.png')
user13.photo.attach(io: user13_avatar, filename: '13.png')
user14.photo.attach(io: user14_avatar, filename: '14.png')
user15.photo.attach(io: user15_avatar, filename: '15.png')
user16.photo.attach(io: user16_avatar, filename: '16.png')
user17.photo.attach(io: user17_avatar, filename: '17.png')
user18.photo.attach(io: user18_avatar, filename: '18.png')
user19.photo.attach(io: user19_avatar, filename: '19.png')
user20.photo.attach(io: user20_avatar, filename: '20.png')
